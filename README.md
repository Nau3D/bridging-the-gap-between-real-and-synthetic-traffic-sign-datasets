...
When real data is available it is possible to add more information to the generator. In our work we explored adding brightness information. We found that all the studied datasets obbeyed a Johnson distribution regarding lightness and were able to obtain the parameters of such distribution for each data set.
